...
public class ReleasingHadokenFirstWaveMagmaDragoon : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        releasingPosition = animator.GetComponent<MagmaDragoon>().hadokenFirstWavePoint;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            var hadoken = Instantiate(hadokenPrefab, releasingPosition.position, releasingPosition.rotation);
