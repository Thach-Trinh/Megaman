...
public class WebSpiderOnGroundSmallSpider : StateMachineBehaviour
{
    //public float offset;
    public int speed;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        var isOnAir = Physics2D.OverlapCircle(foot.position, 0.1f, LayerMask.GetMask("Ground")) == null;
        if (isOnAir) animator.SetTrigger("IsOnAir");
